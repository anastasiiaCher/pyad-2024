...
books.loc[invalid_rows.index] = books.loc[invalid_rows.index].apply(shift_row_right, axis=1, start_index=start_index, columns=columns)
books = books.iloc[:, :-3]
